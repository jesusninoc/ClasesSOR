...
## En tu Windows Server (red aislada), instala el rol de servidor DHCP, crea un ámbito y autorízalo (MUY IMPORTANTE). En tu servidor Linux, instala isc-dhcp-server y configura un ámbito en /etc/dhcp/dhcpd.conf. 
```Bash
